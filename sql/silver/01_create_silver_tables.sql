...
--
-- Purpose
-- Cleaned and standardised data ready for dimensional modelling.
-- ===========================================================
...
DROP TABLE IF EXISTS silver.ae_attendances;

CREATE TABLE silver.ae_attendances
(
    trust_code          VARCHAR(10) PRIMARY KEY,
    region              VARCHAR(100),
...
DROP TABLE IF EXISTS silver.system_mapping;

CREATE TABLE silver.system_mapping
(
